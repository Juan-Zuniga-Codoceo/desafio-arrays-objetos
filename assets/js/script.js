document.write('<p>Estadisticas centro medico ñuñoa</p>');
        ...
        //Agregar elementos al array traumatologia
        traumatologia.push(
        ...
        //Lista consultas medicas de dental
        ...
        //Pacientes Isapre en Dental
        var pacientesIsapre = dental.filter(function(consulta) {
        ...
        //Pacientes Fonasa en traumatologia
        var pacientesFonasa = traumatologia.filter(function(consulta) {
        ...
        //Actualizar tabla dinamicamente
        function actualizarTabla(data, tableId) {
        ...
        actualizarTabla(radiologia, 'radiologiaTable');
        actualizarTabla(traumatologia, 'traumatologiaTable');
        actualizarTabla(dental, 'dentalTable');
